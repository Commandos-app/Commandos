...
import {
    ...
    windowRestoreIcon, twoWayArrowsIcon, userIcon, refreshIcon, happyFaceIcon, arrowIcon, circleArrowIcon
} from '@cds/core/icon';
...
const icons = [
    ...
    refreshIcon, happyFaceIcon, arrowIcon, circleArrowIcon, twoWayArrowsIcon
]
